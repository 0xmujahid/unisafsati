            ...
            <div className="lg:col-span-2">
              <div className="bg-blue-50 p-6 rounded-lg border border-blue-100 mb-8">
                ...
                <ul className="space-y-2 text-gray-700">
                  <li>NVQ Level Diploma in business</li>
                  <li>Level 3 Diploma in Health and Social Care</li>
                  <li>Level 3 Diploma in Child Care</li>
                  <li>Level 3 Diploma in Computing</li>
                  <li>Level 3 Diploma in Law</li>
                </ul>
              </div>
            </div>
