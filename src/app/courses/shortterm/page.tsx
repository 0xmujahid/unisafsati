            ...
            <div className="lg:col-span-2">
              <div className="bg-blue-50 p-6 rounded-lg border border-blue-100 mb-8">
                ...
                <ul className="space-y-2 text-gray-700">
                  ...
                  <li>Level 3 Customer Services</li>
                  <li>Level 3 Health and Social Care</li>
                  <li>Level 3 award in Education and Training(PTLLS)</li>
                  <li>Level 4 Diploma in Education and Training(DTLLS)</li>
                  <li>Funtional Skills English and Maths</li>
                </ul>
              </div>
            </div>
