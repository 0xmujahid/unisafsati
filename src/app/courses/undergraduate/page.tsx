            ...
            <div className="lg:col-span-2">
              <div className="bg-blue-50 p-6 rounded-lg border border-blue-100 mb-8">
                ...
                <ul className="space-y-2 text-gray-700">
                  ...
                  <li>HND in Health and Social Care</li>
                  <li>Bsc in Business and Tourism Management with Foundation</li>
                  <li>Bsc in Computing with Foundation</li>
                  <li>BA(HONS) in Accounting & Finance with Foundation</li>
                  <li>BA(HONS) in Business(Top Up)</li>
                  <li>BA(HONS) in Global Business and Management Foundation</li>
                  <li>BA(HONS) in International Business with Foundation</li>
                  <li>Bsc in Health and Social Care Foundation</li>
                  <li>Bsc in Health Care Management(Top Up)</li>
                  <li>BA(Hons) in Cyber Security with Foundation </li>
                  <li>LLB(Hons) (QLD)</li>
                  <li>Bsc(HONS) in Criminology and Psychology</li>
                  <li>Bsc(HONS) in Construction Management</li>
                  <li>BSC(HONS) in Public Health</li>
