      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative">
        <div className="flex flex-col md:flex-row">
          ...
          >
            ...
            Learn Anywhere, Anytime <br />Online Education & Remote Classes

            </h2>
            <div className="max-w-lg">
              <p className="text-black text-base sm:text-lg md:text-xl mb-6 sm:mb-10 leading-relaxed">
                
Unlock the power of education from the comfort of your home! Our online education and remote classes offer personalized support and expert guidance to help you achieve your academic goals, no matter where you are in the world.
              </p>
